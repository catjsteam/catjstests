...
//                    }
    ...
    function _process(config) {
        ...
        if (_cat.utils.iframe.isIframe()) {
            ...
            if (fullScrap) {
                catParent.core.clientmanager.updateIframe(fullScrap);
            }
        }
    ...
    return {
        ...
        updateIframe : function(scrap) {
            if (intervalObj && intervalObj.interval && scrap && (intervalObj.signScrapId === scrap.id)) {
                clearInterval(intervalObj.interval);
            }
        }
